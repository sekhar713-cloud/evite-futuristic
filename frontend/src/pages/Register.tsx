...
export default function Register() {
  ...
  return (
    <div className="page-bg flex items-center justify-center min-h-screen px-4">
      <div className="orb animate-float" style={{ width: 500, height: 500, background: '#ec4899', opacity: 0.1, top: -100, right: -100 }} />
      <div className="orb animate-float-slow" style={{ width: 400, height: 400, background: '#7c3aed', opacity: 0.1, bottom: -100, left: -100 }} />
      ...
      <div className="glass w-full max-w-md p-8 animate-slide-up relative">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-semibold text-2xl text-white mt-4 mb-1">Create your account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="text" className="input-field" placeholder="coolhost" value={username} onChange={e => setUsername(e.target.value)} required minLength={3} />
          </div>
          <div>
